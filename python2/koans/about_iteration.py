...
class AboutIteration(Koan):
    ...
    def test_reduce_will_blow_your_mind(self):
        ...
        """ calls a two argument function over an iterator similiar to map using
        The value in the iterator as one argument and the result of the previous
        function as the second argument reducing the iterator set to a single 
        value"""
